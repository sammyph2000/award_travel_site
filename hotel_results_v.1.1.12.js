...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function plotHotelLocations(hotelData) {
        hotelData.forEach(function(hotel) {
            ...
            // Prepare content for the info window with checks for missing data
            var contentString = '<div><strong>' + hotel.hotel_name + '</strong><br>' +
                                'Brand: ' + hotel.brand + '<br>';
    
            // Check and format cash per night data
            var cashPerNight = hotel.prices.cash && hotel.prices.cash.cash_per_night != null
                               ? '$' + hotel.prices.cash.cash_per_night.toFixed(2)
                               : 'N/A';
    
            // Check and format points per night data
            ...
            // Add cash and points data to the content string
            contentString += 'Cash per night: ' + cashPerNight + '<br>' +
                             'Points per night: ' + pointsPerNight + '</div>';
