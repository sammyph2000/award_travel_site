...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function getContentString(hotel) {
        ...
        return `<div style="border-radius: 20px; border: 3px solid #3bdb6b; display: flex; align-items: center; justify-content: center; box-shadow: none;">
                    <div style="display: flex; background-color: #fff; padding: 10px; border-radius: 20px;">
                        <img src="${hotel.image_urls[0]}" style="max-width: 100px; max-height: 150px; width: auto; height: auto; margin-right: 10px;">
                        <div style="display: flex; flex-direction: column; justify-content: space-between;">
                            <h4 style="margin: 0; font-size: 14px; font-weight: bold;">${hotel.hotel_name}</h4>
                            <p style="margin: 5px 0; font-size: 12px;">${parentCoTitleCase}</p>
                            <p style="margin: 5px 0; font-size: 12px;">Cash per night: ${cashPrice}</p>
                            <p style="margin: 5px 0; font-size: 12px;">Points per night: ${pointsPrice}</p>
