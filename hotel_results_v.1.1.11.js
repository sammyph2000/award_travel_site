    ...
    function plotHotelLocations(hotelData) {
        hotelData.forEach(function(hotel) {
            ...
            var infoWindow = new google.maps.InfoWindow({
                content: '<div><strong>' + hotel.hotel_name + '</strong><br>' +
                         'Brand: ' + hotel.brand + '<br>' +
                         'Cash per night: $' + hotel.prices.cash.cash_per_night + '<br>' +
                         'Points per night: ' + hotel.prices.points.avg_cost_per_night + ' points</div>'
            });
