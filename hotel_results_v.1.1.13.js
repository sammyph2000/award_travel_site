...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function plotHotelLocations(hotelData) {
        hotelData.forEach(function(hotel) {
            ...
            // Assuming google.maps.marker.AdvancedMarkerElement is similar to google.maps.Marker
            // Refer to the actual API documentation for correct implementation
            ...
            var cashPerNight = hotel.prices.cash && hotel.prices.cash.cash_per_night != null
                               ? '$' + hotel.prices.cash.cash_per_night.toFixed(2)
                               : 'Unknown';
            var pointsPerNight = hotel.prices.points && hotel.prices.points.avg_cost_per_night != null
                                 ? hotel.prices.points.avg_cost_per_night.toLocaleString() + ' points'
                                 : 'Unknown';
            ...
            var contentString = '<div style="display: flex; border: 1px solid #3bdb6b; border-radius: 20px; overflow: hidden;">' +
                                '<div style="flex: 1;"><img src="' + imageUrl + '" style="width: 100%; height: auto; border-right: 1px solid #3bdb6b;"></div>' +
