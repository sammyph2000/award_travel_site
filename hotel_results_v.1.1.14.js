    ...
    function plotHotelLocations(hotelData) {
        ...
        hotelData.forEach(function(hotel) {
            ...
            var marker = new google.maps.Marker({
                ...
                // Assuming there's a method to set color; actual implementation may vary
                icon: {
            ...
            var contentString = '<div style="border: 3px solid #3bdb6b; border-radius: 20px; overflow: hidden; display: flex; cursor: pointer;">' +
